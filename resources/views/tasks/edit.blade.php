...
@section('main-content')
        ...
        <div class="min-height-200px">
            ...
            <div class="form-group col">
                ...
                <div class="col-sm-8">
                    <input style="height:200px;" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{$task->description}}">
                    @error('description')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    <br>
                ...
                <div class="col-sm-8">
                    <input type="date" class="form-control @error('deadline') is-invalid @enderror" name="deadline" value="{{$task->deadline}}{{}}">
                    @error('deadline')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    <br>
